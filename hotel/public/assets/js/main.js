(function ($) {
  ...
  $('#preloader_place').load("./assets/include/components/preloader.html");
  ...
  $('#navbar').load("./assets/include/components/navbar.html");
  $('#footer').load("./assets/include/components/footer.html");
